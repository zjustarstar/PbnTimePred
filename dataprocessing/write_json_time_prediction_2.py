...
whole_json_path_2 = "/home/cgim/wushukai/code/LeXin/LexinTimePrediction/Data/data-2/pos_distribution_25_patch.json"
...
for i in range(len(indexes_1)):
    if indexes_1[i]+".png" not in area_data:
        continue
    data[indexes_1[i]+".png"] = [sehaoshu_1[i], sekuaishu_1[i], area_data[indexes_1[i]+".png"], pos_data[indexes_1[i]+".png"], time_1[i]]
...
for i in range(len(indexes_2)):
    if indexes_2[i]+".png" not in area_data:
        continue
    data[indexes_2[i]+".png"] = [sehaoshu_2[i], sekuaishu_2[i], area_data[indexes_2[i]+".png"], pos_data[indexes_2[i]+".png"], time_2[i]]
...
whole_json_path ="/home/cgim/wushukai/code/LeXin/LexinTimePrediction/Data/data-2/whole_original.json"
with open(whole_json_path, "w") as f:
    json.dump(data, f)


train_json_path = "/home/cgim/wushukai/code/LeXin/LexinTimePrediction/Data/data-2/train.json"
test_json_path = "/home/cgim/wushukai/code/LeXin/LexinTimePrediction/Data/data-2/test.json"
train_data = {}
test_data = {}
